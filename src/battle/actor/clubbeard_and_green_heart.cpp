...
// constexpr s32 hp = 5;
// constexpr s32 dmgLeap = 2;
// constexpr s32 dmgSwarm = 3;
...
// ActorBlueprint GreenHeart = {
//     .flags = 0,
//     .maxHP = green_heart::hp,
//     .type = ACTOR_TYPE_TUBBA_HEART,
//     .level = ACTOR_LEVEL_TUBBA_HEART,
//     .partCount = ARRAY_COUNT(green_heart::ActorParts),
//     .partsData = green_heart::ActorParts,
//     .initScript = &green_heart::EVS_Init,
//     .statusTable = green_heart::StatusTable,
//     .escapeChance = 0,
//     .airLiftChance = 0,
//     .hurricaneChance = 0,
//     .spookChance = 0,
