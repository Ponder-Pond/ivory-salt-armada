...
ActorPartBlueprint ActorParts[] = {
    {
        ...
        .targetOffset = { 0, 20 },
        .opacity = 255,
        .idleAnimations = goomba_knockdown::DefaultAnims,
        .defenseTable = goomba_knockdown::DefenseTable,
        .eventFlags = ACTOR_EVENT_FLAGS_NONE,
        .elementImmunityFlags = 0,
        .projectileTargetOffset = { 0, -10 },
    },
...
EvtScript EVS_KnockDown = {
    ...
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_Goomba_Idle)
    Call(SetActorFlagBits, ACTOR_SELF, ACTOR_FLAG_FLYING, false)
    Call(SetStatusTable, ACTOR_SELF, Ref(goomba_knockdown::StatusTable))
    Call(SetActorType, ACTOR_SELF, ACTOR_TYPE_GOOMBA)
    ExecWait(goomba_knockdown::EVS_Init)
