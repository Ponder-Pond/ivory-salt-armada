...
extern EvtScript EVS_Kroxin_GoHome;
extern EvtScript EVS_Flipped_SpinSmashHit;
extern EvtScript EVS_Flipped_SpinSmashDeath;
extern EvtScript EVS_FlipOver;
extern EvtScript EVS_Attack_ShellToss;
...
// Actor Stats
constexpr s32 hp = 12;
constexpr s32 dmgShellTossPlayer = 2;
constexpr s32 dmgShellTossPartner = 1;
constexpr s32 dmgHeavyStomp = 3;

s32 FlipPosOffsets[] = { 9, 16, 22, 26, 30, 32, 33, 32, 30, 26, 22, 16, 9, 0, 4, 6, 7, 6, 4, 0, 2, 0 };

s32 DefaultAnims[] = {
    STATUS_KEY_NORMAL,    ANIM_KentCKoopa_Kroxin_Anim01,
    STATUS_KEY_STONE,     ANIM_KentCKoopa_Kroxin_Anim00,
    STATUS_KEY_SLEEP,     ANIM_KentCKoopa_Kroxin_Anim13,
    STATUS_KEY_POISON,    ANIM_KentCKoopa_Kroxin_Anim01,
    STATUS_KEY_STOP,      ANIM_KentCKoopa_Kroxin_Anim00,
    STATUS_KEY_STATIC,    ANIM_KentCKoopa_Kroxin_Anim00,
    STATUS_KEY_PARALYZE,  ANIM_KentCKoopa_Kroxin_Anim00,
    STATUS_KEY_DIZZY,     ANIM_KentCKoopa_Kroxin_Anim14,
    STATUS_KEY_UNUSED,    ANIM_KentCKoopa_Kroxin_Anim00,
    STATUS_END,
};

s32 FlippedAnims[] = {
    STATUS_KEY_NORMAL,    ANIM_KentCKoopa_Kroxin_Anim1A,
    STATUS_KEY_STOP,      ANIM_KentCKoopa_Kroxin_Anim19,
    STATUS_KEY_PARALYZE,  ANIM_KentCKoopa_Kroxin_Anim19,
    STATUS_END,
};
...
EvtScript EVS_HandleEvent = {
    ...
    Switch(LVarD)
        ...
        CaseEq(EVENT_ZERO_DAMAGE)
            ...
            Else
                SetConst(LVar0, PRT_MAIN)
                SetConst(LVar1, ANIM_KentCKoopa_Kroxin_Anim1A)
                ExecWait(EVS_Enemy_NoDamageHit)
            EndIf
        CaseEq(EVENT_IMMUNE)
            Call(SetActorVar, ACTOR_SELF, AVAR_FlipResistance, 2)
...
EvtScript EVS_TakeTurn = {
    ...
    IfEq(LVar0, 1)
        ...
        Else
            ...
            Call(MoveBattleCamOver, 15)
            Call(SetAnimationRate, ACTOR_SELF, PRT_MAIN, Float(1.0))
            Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_KentCKoopa_Kroxin_Anim19)
            Thread
                Wait(3)
                Call(GetStatusFlags, ACTOR_SELF, LVar0)
                IfNotFlag(LVar0, STATUS_FLAG_SHRINK)
...
EvtScript EVS_Attack_ShellToss = {
    ...
    Call(MoveBattleCamOver, 25)
    Wait(20)
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_KentCKoopa_Kroxin_Anim0B)
    Wait(10)
    Thread
        Call(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
        Add(LVar1, 4)
    ...
    Call(SetActorSounds, ACTOR_SELF, ACTOR_SOUND_WALK, SOUND_NONE, SOUND_NONE)
    Call(PlaySoundAtActor, ACTOR_SELF, SOUND_KENT_C_SHELL_TOSS_LOOP)
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_KentCKoopa_Kroxin_Anim0A)
    Wait(10)
    Call(EnemyTestTarget, ACTOR_SELF, LVarA, 0, 0, 3, BS_FLAGS1_INCLUDE_POWER_UPS)
    Switch(LVarA)
        CaseOrEq(HIT_RESULT_MISS)
        CaseOrEq(HIT_RESULT_LUCKY)
            ...
            Switch(LVarB)
                CaseEq(6)
                    ...
                    Wait(8)
                    Call(YieldTurn)
                    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_KentCKoopa_Kroxin_Anim01)
                    Call(EnableIdleScript, ACTOR_SELF, IDLE_SCRIPT_ENABLE)
                    Call(UseIdleAnimation, ACTOR_SELF, true)
                    Return
                CaseDefault
    ...
    Call(MoveBattleCamOver, 20)
    SetConst(LVar0, PRT_MAIN)
    SetConst(LVar1, ANIM_KentCKoopa_Kroxin_Anim04)
    ExecWait(EVS_Enemy_ReturnHome)
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_KentCKoopa_Kroxin_Anim01)
    Call(EnableIdleScript, ACTOR_SELF, IDLE_SCRIPT_ENABLE)
    Call(UseIdleAnimation, ACTOR_SELF, true)
...
EvtScript EVS_Attack_HeavyStomp = {
    ...
    Set(LVar1, 0)
    Call(SetActorSpeed, ACTOR_SELF, Float(3.0))
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_KentCKoopa_Kroxin_Anim03)
    Call(SetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
    Call(RunToGoal, ACTOR_SELF, 0, false)
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_KentCKoopa_Kroxin_Anim01)
    Wait(8)
    ...
    Switch(LVar0)
        ...
        CaseOrEq(HIT_RESULT_LUCKY)
            Set(LVarA, LVar0)
            Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_KentCKoopa_Kroxin_Anim06)
            Thread
                Wait(7)
                Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_KentCKoopa_Kroxin_Anim07)
                Wait(4)
                Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_KentCKoopa_Kroxin_Anim08)
            EndThread
            Call(SetActorJumpGravity, ACTOR_SELF, Float(1.0))
            Call(SetGoalToTarget, ACTOR_SELF)
            Call(GetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            ...
            Call(SetGoalToHome, ACTOR_SELF)
            Call(SetActorSpeed, ACTOR_SELF, Float(6.0))
            Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_KentCKoopa_Kroxin_Anim04)
            Call(SetPartYaw, ACTOR_SELF, PRT_MAIN, 180)
            Call(AddActorDecoration, ACTOR_SELF, PRT_MAIN, 0, ACTOR_DECORATION_SWEAT)
            Call(RunToGoal, ACTOR_SELF, 0, false)
            Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_KentCKoopa_Kroxin_Anim01)
...
EvtScript EVS_FlipOver = {
    ...
    Call(SetIdleAnimations, ACTOR_SELF, PRT_MAIN, Ref(FlippedAnims))
    Call(N(SetAbsoluteStatusOffsets), -24, 47, 23, 37)
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_KentCKoopa_Kroxin_Anim1C)
    Call(SetActorVar, ACTOR_SELF, AVAR_IsFlipped, true)
    Call(SetActorVar, ACTOR_SELF, AVAR_Anim_Hurt, ANIM_KentCKoopa_Kroxin_Anim12)
    Thread
        Wait(4)
        Call(GetStatusFlags, ACTOR_SELF, LVar0)
        IfNotFlag(LVar0, STATUS_FLAG_SHRINK)
    ...
    Call(SetActorRotation, ACTOR_SELF, 0, 0, 0)
    Call(SetActorDispOffset, ACTOR_SELF, 0, 0, 0)
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_KentCKoopa_Kroxin_Anim1D)
    Wait(1)
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_KentCKoopa_Kroxin_Anim1E)
    Call(SetPartFlagBits, ACTOR_SELF, PRT_WEAK_POINT, ACTOR_PART_FLAG_NO_TARGET, false)
    Call(SetPartFlagBits, ACTOR_SELF, PRT_WEAK_POINT, ACTOR_PART_FLAG_PRIMARY_TARGET, true)
    Call(SetPartFlags, ACTOR_SELF, PRT_FLIPPED, ACTOR_PART_FLAG_NO_SHADOW)
    Call(SetPartFlags, ACTOR_SELF, PRT_MAIN, ACTOR_PART_FLAG_NO_TARGET | ACTOR_PART_FLAG_NO_SHADOW)
...
ActorBlueprint Kroxin = {
    .flags = 0,
    .maxHP = kroxin::hp,
    .type = ACTOR_TYPE_KROXIN,
    .level = ACTOR_LEVEL_KROXIN,
    .partCount = ARRAY_COUNT(kroxin::ActorParts),
    .partsData = kroxin::ActorParts,
    .initScript = &kroxin::EVS_Init,
    .statusTable = kroxin::StatusTable,
    .escapeChance = 0,
    .airLiftChance = 0,
    .hurricaneChance = 0,
    .spookChance = 0,
