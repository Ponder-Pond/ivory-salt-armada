...
/// Ship
#include "area_shp/shp.h"
MapConfig shp_maps[] = {
    { MAP(shp_00), .bgName = "shp_bg" },
};

/// Port
#include "area_prt/prt.h"
MapConfig prt_maps[] = {
    { MAP(prt_00), .bgName = "shp_bg" },
};

/// Tropical
#include "area_trp/trp.h"
MapConfig trp_maps[] = {
    { MAP(trp_00), .bgName = "shp_bg" },
    { MAP(trp_01), .bgName = "shp_bg" },
};

/// Grass
#include "area_grs/grs.h"
MapConfig grs_maps[] = {
    { MAP(grs_01), .bgName = "shp_bg" },
};

/// Desert
#include "area_dst/dst.h"
MapConfig dst_maps[] = {
    { MAP(dst_00), .bgName = "shp_bg" },
    { MAP(dst_01), .bgName = "shp_bg" },
    { MAP(dst_05) },
};
