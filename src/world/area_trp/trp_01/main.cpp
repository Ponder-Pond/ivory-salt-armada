...
#include "world/common/enemy/JungleFuzzy_Wander.inc.cpp"
...
NpcData NpcData_JungleFuzzy1 = {
    ...
    .extraAnimations = ExtraAnims_JungleFuzzy,
};
...
#include "world/common/enemy/SpearGuy_Wander.inc.cpp"
...
extern "C" export MapSettings trp_01_settings = {
...
extern "C" export s32 trp_01_map_init(void) {
